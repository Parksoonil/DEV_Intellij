        ...
        <div class="nav-bar">
            <div class="nav-container">
                <c:forEach items="${navigationItems}" var="item">
                    <c:choose>
                        <c:when test="${item.jsFunction != null}">
                            <a href="${item.url}" class="nav-item" onclick="${item.jsFunction}">
        ...
        <div class="modules-container">
            ...
            <div class="module-wrapper">
                ...
                <div class="module-content">
                    ...
                    <iframe src="http://localhost:8082/module2/" class="module-frame" id="module3Frame" onload="hideLoading('loading3')" scrolling="no"></iframe>
                </div>
                <div class="module-footer">
                    <a href="http://localhost:8082/module2/" target="_blank" class="module-link">모듈 3 전체보기</a>
                </div>
            </div>
        </div>
    </div>
