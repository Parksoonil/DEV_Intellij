    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form:form modelAttribute="boardDTO" action="/boards/${boardDTO.id}/edit" method="post">
                    <div class="form-row">
                        <div class="form-col">
                        ...
                        <div class="form-icon">
                            ...
                            <select id="boardType" name="boardType" class="form-control">
                                <c:forEach var="boardType" items="${boardTypes}">
                                    <option value="${boardType}" ${boardDTO.boardType == boardType ? 'selected' : ''}>${boardType}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="buttons">
                        ...
                        <a href="/boards/${boardDTO.id}" class="btn btn-danger">
